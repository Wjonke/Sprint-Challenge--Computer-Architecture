...
class CPU:
    ...
    def push(self, x=None):
        self.register[self.sp] -= 1  # Decrement to get room for a deeper stack
    ...
    def pop(self, ret=False):
        ...
        self.register[self.sp] += 1  # Increment for a one shallower stack
    ...
    def load(self, filename):
        ...
        with open(filename) as file:
            for line in file:
                ...
                # getting down to business in the memory array of
                # the same index as this line of this file put the value from this line of this file

                self.ram[address] = int(line, 2)
                # breaks "line" into binary (Base 2)
